...
> **Language:** [English](GRPC_ADAPTER_IMPLEMENTATION.md) | **한국어**

## 목차

- [1. 완전한 어댑터 구현](#1-완전한-어댑터-구현)
  - [1.1 Value Mapper (타입 변환)](#11-value-mapper-타입-변환)
  - [1.2 Container Adapter (주요 변환)](#12-container-adapter-주요-변환)
- [2. 서비스 구현 예제](#2-서비스-구현-예제)
  - [2.1 완전한 gRPC 서비스](#21-완전한-grpc-서비스)
  - [2.2 서버 실행기](#22-서버-실행기)
- [3. 클라이언트 구현](#3-클라이언트-구현)
- [4. 사용 예제](#4-사용-예제)
  - [4.1 서버 사용법](#41-서버-사용법)
  - [4.2 클라이언트 사용법](#42-클라이언트-사용법)
- [5. 빌드 지침](#5-빌드-지침)
- [6. 수정 없이 테스트하기](#6-수정-없이-테스트하기)
