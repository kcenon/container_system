...
If you discover a security vulnerability in Container System, please report it
responsibly through one of the following channels:

- **Email**: [kcenon@naver.com](mailto:kcenon@naver.com)
- **GitHub Security Advisories**: [Report here](https://github.com/kcenon/container_system/security/advisories/new)
...
When using Container System in your projects:

- Always use the latest stable release
- Monitor the [GitHub Security Advisories](https://github.com/kcenon/container_system/security/advisories) page for updates
